...
public class DivisibleByValidatorTest {
	...
	private final String schema = 
		"{" +
			...
			"\"divisibleBy\": 5" +
		"}";
	private final String json1 = "15";
	private final String json2 = "16";
	
	private ObjectMapper mapper;
	private DivisibleByValidator v;
	
	public DivisibleByValidatorTest() throws Exception {
		mapper = new ObjectMapper();
		v = new DivisibleByValidator( mapper.readTree(schema).get(DivisibleByValidator.PROPERTY) );
	}
	...
	public void validateFailure() throws Exception {
		...
		assertThat(errors.get(0), is("$: must be divisible by 5"));
	}
